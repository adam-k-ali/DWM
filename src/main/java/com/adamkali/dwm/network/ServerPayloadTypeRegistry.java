...
public class ServerPayloadTypeRegistry {
    ...
    public static void initialize() {
        ...
        PayloadTypeRegistry.clientboundPlay().register(SyncBotiInteriorS2CPayload.ID, SyncBotiInteriorS2CPayload.CODEC);
        PayloadTypeRegistry.clientboundPlay().register(SyncSotoExteriorS2CPayload.ID, SyncSotoExteriorS2CPayload.CODEC);
        PayloadTypeRegistry.clientboundPlay().register(SyncSotoExteriorChunkS2CPayload.ID, SyncSotoExteriorChunkS2CPayload.CODEC);
        PayloadTypeRegistry.clientboundPlay().register(UnloadSotoExteriorChunkS2CPayload.ID, UnloadSotoExteriorChunkS2CPayload.CODEC);
        PayloadTypeRegistry.clientboundPlay().register(SyncSotoExteriorEntitySpawnS2CPayload.ID, SyncSotoExteriorEntitySpawnS2CPayload.CODEC);
        PayloadTypeRegistry.clientboundPlay().register(SyncSotoExteriorEntityUpdateS2CPayload.ID, SyncSotoExteriorEntityUpdateS2CPayload.CODEC);
        PayloadTypeRegistry.clientboundPlay().register(SyncSotoExteriorEntityRemoveS2CPayload.ID, SyncSotoExteriorEntityRemoveS2CPayload.CODEC);
        ...
        PayloadTypeRegistry.serverboundPlay().register(RequestBotiInteriorC2SPayload.ID, RequestBotiInteriorC2SPayload.CODEC);
        PayloadTypeRegistry.serverboundPlay().register(RequestSotoExteriorC2SPayload.ID, RequestSotoExteriorC2SPayload.CODEC);
        PayloadTypeRegistry.serverboundPlay().register(RequestSotoGhostC2SPayload.ID, RequestSotoGhostC2SPayload.CODEC);
    ...
    static boolean safelyHandleChameleonUpdate(UpdateTardisChameleonC2SPayload payload, String playerName) {
        try {
            ...
            SotoExteriorSyncService.setChanged(payload.tardisId());
            return true;
    ...
    static boolean safelyHandleBotiRequest(RequestBotiInteriorC2SPayload payload, net.minecraft.server.level.ServerPlayer player) {
    ...
    static boolean safelyHandleSotoRequest(RequestSotoExteriorC2SPayload payload, net.minecraft.server.level.ServerPlayer player) {
    ...
    static boolean safelyHandleSotoGhostRequest(RequestSotoGhostC2SPayload payload, net.minecraft.server.level.ServerPlayer player) {
        if (payload == null || payload.tardisId() == null || player == null) {

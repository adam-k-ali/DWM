...
public class DWMPacketIds {
    ...
    public static final Identifier REQUEST_SOTO_GHOST_PACKET_ID = Identifier.of(DWMReference.MOD_ID, "request_soto_ghost");
    public static final Identifier SYNC_SOTO_EXTERIOR_CHUNK_PACKET_ID = Identifier.of(DWMReference.MOD_ID, "sync_soto_exterior_chunk");
    public static final Identifier UNLOAD_SOTO_EXTERIOR_CHUNK_PACKET_ID = Identifier.of(DWMReference.MOD_ID, "unload_soto_exterior_chunk");

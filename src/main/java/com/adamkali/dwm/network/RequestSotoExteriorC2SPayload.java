...
public record RequestSotoExteriorC2SPayload(UUID tardisId, int viewDistanceChunks) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, RequestSotoExteriorC2SPayload> CODEC = PacketCodec.tuple(
            ...
            PacketCodecs.VAR_INT, RequestSotoExteriorC2SPayload::viewDistanceChunks,

...
public class DarkAshWoodFamilyGameTests implements FabricGameTest {
    ...
    public void blockLootDropsExpectedItems(TestContext context) {
        ...
        context.setBlockState(slabPos, DWMBlocks.DARK_ASH_SLAB.getDefaultState().with(SlabBlock.TYPE, SlabType.BOTTOM));
        assertDropsContain(context, player, slabPos, ItemStack.EMPTY, DWMBlocks.DARK_ASH_SLAB.asItem(), 1);

        context.setBlockState(slabPos, DWMBlocks.DARK_ASH_SLAB.getDefaultState().with(SlabBlock.TYPE, SlabType.DOUBLE));
        ...
        context.setBlockState(wallSignPos, DWMBlocks.DARK_ASH_WALL_SIGN.getDefaultState());
        ...
        context.setBlockState(wallHangingPos, DWMBlocks.DARK_ASH_WALL_HANGING_SIGN.getDefaultState());
        ...
        context.setBlockState(pottedPos, DWMBlocks.POTTED_DARK_ASH_SAPLING.getDefaultState());
        ...
        context.setBlockState(leavesPos, DWMBlocks.DARK_ASH_LEAVES.getDefaultState());
    ...
    public void orientedBlocksAcceptSupportedDirections(TestContext context) {
        ...
        for (Direction facing : Direction.Type.HORIZONTAL) {
            ...
            context.setBlockState(pos, DWMBlocks.DARK_ASH_STAIRS.getDefaultState().with(StairsBlock.FACING, facing));
            context.expectBlockProperty(pos, StairsBlock.FACING, facing);
        }

        BlockPos bottomSlab = new BlockPos(1, 3, 1);
        context.setBlockState(bottomSlab, DWMBlocks.DARK_ASH_SLAB.getDefaultState().with(SlabBlock.TYPE, SlabType.BOTTOM));
        context.expectBlockProperty(bottomSlab, SlabBlock.TYPE, SlabType.BOTTOM);
        BlockPos topSlab = new BlockPos(2, 3, 1);
        context.setBlockState(topSlab, DWMBlocks.DARK_ASH_SLAB.getDefaultState().with(SlabBlock.TYPE, SlabType.TOP));
        context.expectBlockProperty(topSlab, SlabBlock.TYPE, SlabType.TOP);
        BlockPos doubleSlab = new BlockPos(3, 3, 1);
        context.setBlockState(doubleSlab, DWMBlocks.DARK_ASH_SLAB.getDefaultState().with(SlabBlock.TYPE, SlabType.DOUBLE));
        ...
        context.setBlockState(floorButton, DWMBlocks.DARK_ASH_BUTTON.getDefaultState()
        ...
        context.setBlockState(wallButton, DWMBlocks.DARK_ASH_BUTTON.getDefaultState()
        ...
        context.setBlockState(ceilingButton, DWMBlocks.DARK_ASH_BUTTON.getDefaultState()
        ...
        for (Direction facing : Direction.Type.HORIZONTAL) {
            ...
            context.setBlockState(pos, DWMBlocks.DARK_ASH_FENCE_GATE.getDefaultState().with(FenceGateBlock.FACING, facing));
            context.expectBlockProperty(pos, FenceGateBlock.FACING, facing);
        }

        context.setBlockState(5, 5, 5, Blocks.STONE);
        context.setBlockState(5, 6, 5, DWMBlocks.DARK_ASH_PRESSURE_PLATE.getDefaultState());
        context.expectBlock(DWMBlocks.DARK_ASH_PRESSURE_PLATE, 5, 6, 5);

        int trapX = 1;
        for (Direction facing : Direction.Type.HORIZONTAL) {
            BlockPos pos = new BlockPos(trapX++, 7, 2);
            context.setBlockState(pos, DWMBlocks.DARK_ASH_TRAPDOOR.getDefaultState()
    ...
    public void boatPlacesOnWater(TestContext context) {
        ...
        player.setStackInHand(Hand.MAIN_HAND, new ItemStack(DWMItems.DARK_ASH_BOAT));

        var result = DWMItems.DARK_ASH_BOAT.use(context.getWorld(), player, Hand.MAIN_HAND);
        if (!result.isAccepted()) {
            throw new AssertionError("Expected dark ash boat use on water to succeed, got " + result);
        }

        context.expectEntities(DWMEntityTypes.DARK_ASH_BOAT, 1);
        context.complete();
    }
    ...
    public void signPlacementAndText(TestContext context) {
        ...
        context.expectBlock(DWMBlocks.DARK_ASH_SIGN, standingRel);
        ...
        context.expectBlock(DWMBlocks.DARK_ASH_WALL_SIGN, wallSignRel);
        ...
        context.expectBlock(DWMBlocks.DARK_ASH_HANGING_SIGN, hangingRel);
        ...
        context.expectBlock(DWMBlocks.DARK_ASH_WALL_HANGING_SIGN, wallHangingRel);
    ...
    public void saplingGeneratesDarkAshTree(TestContext context) {
        ...
        context.setBlockState(saplingRel, DWMBlocks.DARK_ASH_SAPLING.getDefaultState());
        ...
        for (long seed : List.of(1L, 2L, 3L, 7L, 13L, 42L, 99L)) {
            ...
            world.setBlockState(
                    saplingAbs,
                    DWMBlocks.DARK_ASH_SAPLING.getDefaultState().with(SaplingBlock.STAGE, 1)
            );

...
class SyncSotoExteriorChunkS2CPayloadTest {
    ...
    void fromSample_mapsWorldBlocksToFootprintRelative() {
        ...
        assertEquals(SyncSotoExteriorChunkS2CPayload.ID, payload.type());
    }
    ...
    void unloadPayload_retainsChunkCoords() {
        ...
        assertEquals(UnloadSotoExteriorChunkS2CPayload.ID, payload.type());
    }
    ...
    void entitySpawnUpdateRemove_roundTripFields() {
        ...
        SyncSotoExteriorEntitySpawnS2CPayload spawn = new SyncSotoExteriorEntitySpawnS2CPayload(
                tardisId, entityId, net.minecraft.resources.Identifier.fromNamespaceAndPath("minecraft", "cow"),
        ...
        assertEquals(SyncSotoExteriorEntitySpawnS2CPayload.ID, spawn.type());
        ...
        assertEquals(SyncSotoExteriorEntityUpdateS2CPayload.ID, update.type());
        ...
        assertEquals(SyncSotoExteriorEntityRemoveS2CPayload.ID, remove.type());
    }
    ...
    void requestGhost_retainsTardisId() {
        ...
        assertEquals(id, payload.tardisId());
        assertEquals(RequestSotoGhostC2SPayload.ID, payload.type());
    }
}

...
public class SixthDoctorTardisModel extends TardisModel {
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(Identifier.of(DWMReference.MOD_ID, "sixth_doctor_box"), "sixth_doctor_box");
    public static final Identifier TEXTURE_LOCATION = Identifier.of(DWMReference.MOD_ID, "textures/entity/sixth_doctor_box.png");
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData Main = modelPartData.addChild("Main", ModelPartBuilder.create().uv(6, 20).cuboid(-2.0F, -6.9F, -1.5F, 12.0F, 1.0F, 1.0F, new Dilation(0.0F))
                ...
                .uv(0, 0).cuboid(-1.5F, -6.35F, -1.1F, 11.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(-1.5F, -6.05F, -0.9F, 11.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(-1.5F, -5.65F, -0.8F, 11.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(-4.0F, 6.9F, -5.7F));
        ...
        ModelPartData LeftDoor = Main.addChild("LeftDoor", ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, 4.0F, 0.0F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
                ...
                .uv(0, 8).cuboid(-0.7F, -12.0F, -0.3F, 1.0F, 21.0F, 1.0F, new Dilation(0.0F))
                ...
                .uv(6, 6).cuboid(-5.0F, -2.0F, -0.3F, 5.0F, 1.0F, 1.0F, new Dilation(0.0F))
                ...
                .uv(0, 9).cuboid(-5.0F, -7.0F, -0.3F, 5.0F, 1.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData bone18 = LeftDoor.addChild("bone18", ModelPartBuilder.create().uv(10, 24).cuboid(0.8964F, -0.4126F, -0.94F, 1.0F, 1.0F, 1.0F, new Dilation(-0.2F)), ModelTransform.pivot(-5.7F, -1.6F, 0.3F));
        ...
        ModelPartData Door2 = Main.addChild("Door2", ModelPartBuilder.create().uv(0, 5).cuboid(0.0F, -7.0F, -0.3F, 5.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(0.95F, -6.8F, -0.2F, 3.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(-0.05F, -6.3F, -0.2F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 2).cuboid(-0.25F, -2.3F, -0.2F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(3.75F, -5.8F, -0.2F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData bone3 = Door2.addChild("bone3", ModelPartBuilder.create().uv(3, 2).cuboid(-1.1036F, -9.9F, -0.8536F, 1.0F, 21.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(5.25F, -2.1F, 0.7F, 0.0F, -0.7854F, 0.0F));
        ...
        ModelPartData Window1_2 = Door2.addChild("Window1_2", ModelPartBuilder.create().uv(2, 23).cuboid(-0.3F, -0.1943F, -0.6891F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(2, 23).cuboid(-0.3F, 3.3589F, -4.2423F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(2, 23).cuboid(-0.3F, 3.2882F, -4.1362F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F))
                ...
                .uv(22, 20).cuboid(-0.4F, 0.6189F, -1.4669F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData window2_2 = Door2.addChild("window2_2", ModelPartBuilder.create().uv(22, 19).cuboid(-4.3891F, -2.4F, 2.9648F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F))
                ...
                .uv(22, 19).cuboid(-4.4421F, 2.6F, 3.0532F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F))
                ...
                .uv(22, 19).cuboid(-6.6342F, 2.6F, 5.2452F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(9.2F, -8.6357F, 0.7766F, 0.0F, -0.7854F, 0.0F));
        ...
        ModelPartData bone19 = Door2.addChild("bone19", ModelPartBuilder.create().uv(6, 29).cuboid(-1.3309F, -0.8124F, -1.2955F, 1.0F, 1.0F, 1.0F, new Dilation(0.025F)), ModelTransform.of(5.1714F, -3.6876F, -0.09F, 0.0F, 1.2217F, 0.0F));

        ModelPartData bone40 = Door2.addChild("bone40", ModelPartBuilder.create().uv(6, 29).cuboid(-0.1818F, -1.0124F, -0.8889F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(5.1214F, -3.6876F, 0.485F, 0.0F, 0.7854F, 0.0F));

        ModelPartData bone16 = Main.addChild("bone16", ModelPartBuilder.create().uv(0, 0).cuboid(-6.0F, 0.3397F, -0.842F, 12.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(4.0F, -7.7F, -0.9F, 0.3491F, 0.0F, 0.0F));

        ModelPartData bone17 = Main.addChild("bone17", ModelPartBuilder.create().uv(0, 0).cuboid(-6.0F, 0.7276F, -0.0896F, 12.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(4.0F, -7.3F, -0.9F, -0.3491F, 0.0F, 0.0F));
        ...
        ModelPartData Main2 = modelPartData.addChild("Main2", ModelPartBuilder.create().uv(0, 8).cuboid(-5.0F, -2.0F, -6.3F, 10.0F, 1.0F, 1.0F, new Dilation(0.0F))
                ...
                .uv(0, 0).cuboid(-5.5F, -23.45F, -6.8F, 11.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(-5.5F, -23.15F, -6.6F, 11.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(-5.5F, -22.75F, -6.5F, 11.0F, 1.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData bone22 = Main2.addChild("bone22", ModelPartBuilder.create().uv(0, 0).cuboid(-6.0F, 0.3397F, -0.842F, 12.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -24.8F, -6.6F, 0.3491F, 0.0F, 0.0F));

        ModelPartData bone23 = Main2.addChild("bone23", ModelPartBuilder.create().uv(0, 0).cuboid(-6.0F, 0.7276F, -0.0896F, 12.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -24.4F, -6.6F, -0.3491F, 0.0F, 0.0F));
        ...
        ModelPartData bone28 = Main3.addChild("bone28", ModelPartBuilder.create().uv(0, 0).cuboid(-6.0F, 0.3397F, -0.842F, 12.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -24.8F, -6.6F, 0.3491F, 0.0F, 0.0F));

        ModelPartData bone29 = Main3.addChild("bone29", ModelPartBuilder.create().uv(0, 0).cuboid(-6.0F, 0.7276F, -0.0896F, 12.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -24.4F, -6.6F, -0.3491F, 0.0F, 0.0F));
        ...
        ModelPartData bone34 = Main4.addChild("bone34", ModelPartBuilder.create().uv(0, 0).cuboid(-6.0F, 0.3397F, -0.842F, 12.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -24.8F, -6.6F, 0.3491F, 0.0F, 0.0F));

        ModelPartData bone35 = Main4.addChild("bone35", ModelPartBuilder.create().uv(0, 0).cuboid(-6.0F, 0.7276F, -0.0896F, 12.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -24.4F, -6.6F, -0.3491F, 0.0F, 0.0F));
        ...
        ModelPartData bone41 = modelPartData.addChild("bone41", ModelPartBuilder.create().uv(0, 0).cuboid(-1.0F, 26.1F, -13.0F, 15.0F, 1.0F, 15.0F, new Dilation(0.0F))
                ...
                .uv(0, 0).cuboid(4.5F, 0.2F, -7.5F, 4.0F, 3.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(-6.5F, -3.1F, 5.5F));

        ModelPartData bone42 = bone41.addChild("bone42", ModelPartBuilder.create().uv(24, 28).cuboid(-1.0F, -1.2167F, -1.0F, 2.0F, 2.0F, 2.0F, new Dilation(0.225F)), ModelTransform.of(6.5F, -0.4333F, -5.5F, 0.0F, 0.7854F, 0.0F));

        ModelPartData bone43 = bone42.addChild("bone43", ModelPartBuilder.create().uv(20, 29).cuboid(-0.5F, -0.05F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.2F))
                .uv(28, 26).cuboid(-0.5F, -1.45F, -0.5F, 1.0F, 1.0F, 1.0F, new Dilation(0.2F)), ModelTransform.of(0.0F, 0.1083F, 0.0F, 0.0F, 0.7854F, 0.0F));

...
public class FourthDoctorTardisModel extends TardisModel {
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(Identifier.of(DWMReference.MOD_ID, "fourth_doctor_box"), "fourth_doctor_box");
    public static final Identifier TEXTURE_LOCATION = Identifier.of(DWMReference.MOD_ID, "textures/entity/fourth_doctor_box.png");

    private final ModelPart Door1;

    public FourthDoctorTardisModel(ModelPart root) {
        super(root);
        this.Door1 = root.getChild("Main").getChild("Door1");
    }
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData post = modelPartData.addChild("post", ModelPartBuilder.create().uv(0, 0).cuboid(-1.5F, -24.0F, 0.5F, 1.0F, 24.0F, 1.0F, new Dilation(0.0F))
                ...
                .uv(0, 0).cuboid(-1.1F, -24.85F, 0.4F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(-1.1F, -24.85F, 12.6F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(11.1F, -24.85F, 0.4F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(11.1F, -24.85F, 12.6F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData Door1 = Main.addChild("Door1", ModelPartBuilder.create().uv(0, 2).cuboid(-4.0F, 4.0F, 0.0F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(1, 22).cuboid(-5.0F, 8.0F, -0.3F, 5.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(-5.0F, 4.0F, -0.3F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F))
                ...
                .uv(0, 13).cuboid(-5.0F, -2.0F, -0.3F, 5.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 4).cuboid(-4.0F, -6.0F, 0.0F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData window2_1 = Door1.addChild("window2_1", ModelPartBuilder.create().uv(17, 0).cuboid(-0.6414F, -2.4F, -0.7828F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(17, 0).cuboid(-2.9749F, -2.4F, 1.5506F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(17, 0).cuboid(-2.1971F, -2.4F, 0.7728F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(17, 0).cuboid(-1.4192F, -2.4F, -0.005F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-0.8F, -8.6357F, 0.7766F, 0.0F, -0.7854F, 0.0F));

        ModelPartData Window1_1 = Door1.addChild("Window1_1", ModelPartBuilder.create().uv(17, 0).cuboid(4.7F, -0.1943F, -0.6891F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(17, 0).cuboid(4.7F, -2.952F, 2.0686F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(17, 0).cuboid(4.7F, -1.5378F, 0.6544F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-9.0F, -7.4F, 0.4F, 0.7854F, 0.0F, 0.0F));

        ModelPartData bone19 = Door1.addChild("bone19", ModelPartBuilder.create().uv(6, 29).cuboid(-0.2879F, -1.3F, -0.7121F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(-4.5036F, -3.6876F, 0.56F, 0.0F, 0.7854F, 0.0F));

        ModelPartData bone18 = Door1.addChild("bone18", ModelPartBuilder.create().uv(24, 5).cuboid(0.7964F, -0.3876F, -0.94F, 1.0F, 1.0F, 1.0F, new Dilation(-0.2F)), ModelTransform.pivot(-5.7F, -1.6F, 0.3F));
        ...
        ModelPartData Door2 = Main.addChild("Door2", ModelPartBuilder.create().uv(0, 5).cuboid(0.0F, -7.0F, -0.3F, 5.0F, 1.0F, 1.0F, new Dilation(0.0F))
                ...
                .uv(1, 3).cuboid(0.0F, -1.0F, 0.0F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 5).mirrored().cuboid(0.0F, -2.0F, -0.3F, 5.0F, 1.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
                .uv(0, 10).cuboid(4.0F, -1.0F, -0.3F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 10).cuboid(4.0F, 4.0F, -0.3F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 11).cuboid(0.0F, 3.0F, -0.3F, 5.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(1, 22).cuboid(0.0F, 8.0F, -0.3F, 5.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(0.0F, 4.0F, 0.0F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(-0.3F, -12.0F, -0.3F, 1.0F, 21.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(-1.0F, 7.1F, -0.3F));
        ...
        ModelPartData Window1_2 = Door2.addChild("Window1_2", ModelPartBuilder.create().uv(2, 23).cuboid(-0.3F, -0.1943F, -0.6891F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(22, 19).cuboid(-0.3F, 3.3412F, -4.2246F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(22, 20).cuboid(-0.3F, -2.952F, 2.0686F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(22, 19).cuboid(-0.3F, 0.5835F, -1.4669F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(22, 19).cuboid(-0.3F, 3.4119F, -4.2953F, 4.0F, 1.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData window2_2 = Door2.addChild("window2_2", ModelPartBuilder.create().uv(22, 19).cuboid(-4.3891F, -2.4F, 2.9648F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F))
                ...
                .uv(22, 19).cuboid(-6.7225F, 2.6F, 5.2983F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(9.2F, -8.6357F, 0.7766F, 0.0F, -0.7854F, 0.0F));
        ...
        ModelPartData bone16 = Main.addChild("bone16", ModelPartBuilder.create().uv(0, 0).cuboid(-6.0F, 0.5337F, -0.8762F, 12.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(4.0F, -7.7F, -0.9F, 0.3491F, 0.0F, 0.0F));
        ...
        ModelPartData Main2 = modelPartData.addChild("Main2", ModelPartBuilder.create().uv(0, 16).cuboid(-5.0F, -2.0F, -6.3F, 10.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(22, 15).cuboid(-5.0F, -21.1F, -6.08F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(9, 7).cuboid(1.0F, -6.0F, -6.0F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(11, 10).cuboid(1.0F, -11.0F, -6.0F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(17, 0).cuboid(1.0F, -16.0F, -6.0F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(15, 1).cuboid(-5.0F, -6.0F, -6.0F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(12, 6).cuboid(-5.0F, -11.0F, -6.0F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(10, 7).cuboid(-5.0F, -16.0F, -6.0F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 3).cuboid(-5.0F, -7.0F, -6.3F, 10.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 10).cuboid(-5.0F, -12.0F, -6.3F, 10.0F, 1.0F, 1.0F, new Dilation(0.0F))
                ...
                .uv(3, 12).cuboid(4.3F, -6.0F, -6.3F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData bone21 = Main2.addChild("bone21", ModelPartBuilder.create().uv(3, 0).cuboid(-0.9621F, -10.9F, -0.7121F, 1.0F, 22.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.25F, -12.1F, -5.3F, 0.0F, -0.7854F, 0.0F));

        ModelPartData bone22 = Main2.addChild("bone22", ModelPartBuilder.create().uv(0, 0).cuboid(-6.0F, 0.5337F, -0.8762F, 12.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -24.8F, -6.6F, 0.3491F, 0.0F, 0.0F));
        ...
        ModelPartData Main3 = modelPartData.addChild("Main3", ModelPartBuilder.create().uv(1, 22).cuboid(-5.0F, -2.0F, -6.3F, 10.0F, 1.0F, 1.0F, new Dilation(0.0F))
                ...
                .uv(10, 7).cuboid(1.0F, -11.0F, -6.0F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
                ...
                .uv(9, 9).mirrored().cuboid(-5.0F, -11.0F, -6.0F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F)).mirrored(false)
                .uv(11, 5).cuboid(-5.0F, -16.0F, -6.0F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 4).cuboid(-5.0F, -7.0F, -6.3F, 10.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 15).cuboid(-5.0F, -12.0F, -6.3F, 10.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 1).cuboid(-5.0F, -17.0F, -6.3F, 10.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(-5.0F, -23.0F, -6.3F, 10.0F, 2.0F, 1.0F, new Dilation(0.0F))
                .uv(6, 20).cuboid(-6.0F, -24.0F, -7.2F, 12.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(4.0F, -24.0F, -7.3F, 2.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(-6.0F, -25.85F, -6.6F, 12.0F, 1.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData bone28 = Main3.addChild("bone28", ModelPartBuilder.create().uv(0, 0).cuboid(-6.0F, 0.5337F, -0.8762F, 12.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -24.8F, -6.6F, 0.3491F, 0.0F, 0.0F));
        ...
        ModelPartData Main4 = modelPartData.addChild("Main4", ModelPartBuilder.create().uv(1, 22).cuboid(-5.0F, -2.0F, -6.3F, 10.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(22, 15).cuboid(-5.0F, -21.1F, -6.08F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(2, 4).cuboid(1.0F, -6.0F, -6.0F, 4.0F, 4.0F, 1.0F, new Dilation(0.0F))
                ...
                .uv(0, 9).cuboid(-5.0F, -7.0F, -6.3F, 10.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(9, 4).cuboid(-5.0F, -12.0F, -6.3F, 10.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 5).cuboid(-5.0F, -17.0F, -6.3F, 10.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(-5.0F, -23.0F, -6.3F, 10.0F, 2.0F, 1.0F, new Dilation(0.0F))
                .uv(6, 20).cuboid(-6.0F, -24.0F, -7.2F, 12.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(4.0F, -24.0F, -7.3F, 2.0F, 1.0F, 1.0F, new Dilation(0.0F))
                ...
                .uv(0, 0).cuboid(-6.0F, -24.0F, -7.3F, 2.0F, 1.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(-5.3F, -21.0F, -6.3F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(5, 5).cuboid(4.3F, -21.0F, -6.3F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 4).cuboid(-1.0F, -21.0F, -6.3F, 2.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 8).cuboid(-5.3F, -16.0F, -6.3F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 8).cuboid(4.3F, -16.0F, -6.3F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 8).cuboid(-1.0F, -16.0F, -6.3F, 2.0F, 4.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 7).cuboid(-5.3F, -11.0F, -6.3F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData bone34 = Main4.addChild("bone34", ModelPartBuilder.create().uv(0, 0).cuboid(-6.0F, 0.5337F, -0.8762F, 12.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -24.8F, -6.6F, 0.3491F, 0.0F, 0.0F));
        ...
        ModelPartData baseroof = modelPartData.addChild("baseroof", ModelPartBuilder.create().uv(0, 0).cuboid(0.5F, 26.8F, -13.5F, 14.0F, 1.0F, 14.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(1.5F, 1.9F, -12.5F, 12.0F, 3.0F, 12.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(2.0F, 1.85F, -12.0F, 11.0F, 3.0F, 11.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(2.5F, 1.8F, -11.5F, 10.0F, 3.0F, 10.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(3.0F, 1.75F, -11.0F, 9.0F, 3.0F, 9.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(3.5F, 1.7F, -10.5F, 8.0F, 3.0F, 8.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(4.0F, 1.65F, -10.0F, 7.0F, 3.0F, 7.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(4.5F, 1.6F, -9.5F, 6.0F, 3.0F, 6.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(5.0F, 1.55F, -9.0F, 5.0F, 3.0F, 5.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(5.5F, 1.5F, -8.5F, 4.0F, 3.0F, 4.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(6.0F, 1.15F, -8.0F, 3.0F, 3.0F, 3.0F, new Dilation(0.0F))
                .uv(28, 26).cuboid(7.0F, -1.0F, -7.0F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(-7.5F, -3.8F, 6.5F));

        ModelPartData bone40 = baseroof.addChild("bone40", ModelPartBuilder.create().uv(24, 27).cuboid(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(7.5F, 0.2F, -6.5F, 0.0F, 0.7854F, 0.0F));

...
public class DWMModMenuIntegration implements ModMenuApi {
    ...
    public ConfigScreenFactory<?> getModConfigScreenFactory() {
        return parent -> {
            ...
            general.addEntry(entryBuilder.startBooleanToggle(Component.translatable("dwm.config.option.enable_boti"), DWMConfig.getBoolean(DWMConfig.ENABLE_BOTI)).setDefaultValue(DWMConfig.ENABLE_BOTI.getDefaultValue()).setTooltip(Component.translatable("dwm.config.option.enable_boti.tooltip")).setSaveConsumer((newValue) -> DWMConfig.setBoolean(DWMConfig.ENABLE_BOTI, newValue)).build());
            general.addEntry(entryBuilder.startBooleanToggle(Component.translatable("dwm.config.option.enable_soto"), DWMConfig.getBoolean(DWMConfig.ENABLE_SOTO)).setDefaultValue(DWMConfig.ENABLE_SOTO.getDefaultValue()).setTooltip(Component.translatable("dwm.config.option.enable_soto.tooltip")).setSaveConsumer((newValue) -> DWMConfig.setBoolean(DWMConfig.ENABLE_SOTO, newValue)).build());

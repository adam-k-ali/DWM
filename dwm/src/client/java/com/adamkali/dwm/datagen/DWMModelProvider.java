...
public class DWMModelProvider extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerators itemModelGenerator) {
        ...
        itemModelGenerator.generateFlatItem(DWMItems.STEEL_SWORD, ModelTemplates.FLAT_HANDHELD_ITEM);
        itemModelGenerator.generateFlatItem(DWMItems.STEEL_SHOVEL, ModelTemplates.FLAT_HANDHELD_ITEM);
        ...
        itemModelGenerator.generateFlatItem(DWMItems.EVA_SUIT_HELMET, ModelTemplates.FLAT_ITEM);
        itemModelGenerator.generateFlatItem(DWMItems.EVA_SUIT_CHESTPLATE, ModelTemplates.FLAT_ITEM);
        itemModelGenerator.generateFlatItem(DWMItems.EVA_SUIT_LEGGINGS, ModelTemplates.FLAT_ITEM);
        itemModelGenerator.generateFlatItem(DWMItems.EVA_SUIT_BOOTS, ModelTemplates.FLAT_ITEM);

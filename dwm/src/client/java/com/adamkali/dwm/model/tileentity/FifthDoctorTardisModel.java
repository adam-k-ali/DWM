...
public class FifthDoctorTardisModel extends TardisModel {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Identifier.fromNamespaceAndPath(DWMReference.MOD_ID, "fifth_doctor_box"), "fifth_doctor_box");
    public static final Identifier TEXTURE_LOCATION = Identifier.fromNamespaceAndPath(DWMReference.MOD_ID, "textures/entity/fifth_doctor_box.png");
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition LeftDoor = modelPartData.addOrReplaceChild("LeftDoor", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, 4.0F, 0.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(3, 15).addBox(-5.0F, 8.0F, -0.3F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(7, 6).addBox(-5.0F, 4.0F, -0.3F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(7, 14).mirror().addBox(-4.0F, -1.0F, 0.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(0, 9).addBox(-5.0F, -2.0F, -0.3F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(22, 15).addBox(-4.775F, -11.1F, -0.08F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(5.0F, 14.0F, -6.0F));
        ...
        PartDefinition bone18 = LeftDoor.addOrReplaceChild("bone18", CubeListBuilder.create().texOffs(10, 24).addBox(0.8964F, -0.4376F, -0.94F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.2F)), PartPose.offset(-5.7F, -1.6F, 0.3F));

        PartDefinition bone3 = LeftDoor.addOrReplaceChild("bone3", CubeListBuilder.create().texOffs(3, 2).addBox(-1.1036F, -9.9F, -0.8536F, 1.0F, 21.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.75F, -2.1F, 0.7F, 0.0F, -0.7854F, 0.0F));

        PartDefinition bone40 = LeftDoor.addOrReplaceChild("bone40", CubeListBuilder.create().texOffs(6, 29).addBox(-0.1818F, -1.0124F, -0.8889F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.8786F, -3.6876F, 0.485F, 0.0F, 0.7854F, 0.0F));

        PartDefinition rightDoor = modelPartData.addOrReplaceChild("rightDoor", CubeListBuilder.create().texOffs(0, 5).addBox(0.0F, -7.0F, -0.3F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 9).addBox(0.0F, -2.0F, -0.3F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(5, 10).addBox(4.0F, -1.0F, -0.3F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(5, 8).addBox(4.0F, 4.0F, -0.3F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 15).addBox(0.0F, 3.0F, -0.3F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(2, 12).addBox(0.0F, 8.0F, -0.3F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 0).addBox(3.75F, -5.775F, -0.2F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 3).addBox(-0.25F, -2.275F, -0.2F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-0.05F, -6.275F, -0.2F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(4, 2).addBox(0.95F, -6.775F, -0.2F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 14.0F, -6.0F));

        PartDefinition Window1_2 = rightDoor.addOrReplaceChild("Window1_2", CubeListBuilder.create().texOffs(2, 23).addBox(-0.3F, -0.1943F, -0.6891F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(2, 23).addBox(-0.3F, 3.3766F, -4.26F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(2, 23).addBox(-0.35F, 3.2352F, -4.0832F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(22, 20).addBox(-0.3F, -2.952F, 2.0686F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(22, 20).addBox(-0.3F, 0.5658F, -1.4492F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(22, 20).addBox(-0.45F, 0.6896F, -1.5376F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition window2_2 = rightDoor.addOrReplaceChild("window2_2", CubeListBuilder.create().texOffs(22, 19).addBox(-4.3891F, -2.4F, 2.9648F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(22, 19).addBox(-4.3891F, 2.6F, 2.9648F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(22, 19).addBox(-4.5305F, 2.725F, 3.177F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(22, 19).addBox(-6.7225F, 2.6F, 5.2983F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(22, 19).addBox(-6.5104F, 2.725F, 5.1569F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.2F, -8.6357F, 0.7766F, 0.0F, -0.7854F, 0.0F));

        PartDefinition window3_2 = rightDoor.addOrReplaceChild("window3_2", CubeListBuilder.create(), PartPose.offsetAndRotation(1.0F, -7.1F, 0.3F, 0.3491F, 0.0F, 0.0F));

        PartDefinition bone19 = rightDoor.addOrReplaceChild("bone19", CubeListBuilder.create().texOffs(6, 29).addBox(-1.3485F, -0.8124F, -1.3132F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.025F)), PartPose.offsetAndRotation(5.0964F, -3.6876F, 0.46F, 0.0F, 0.7854F, 0.0F));

        PartDefinition lamp = modelPartData.addOrReplaceChild("lamp", CubeListBuilder.create().texOffs(24, 28).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.325F)), PartPose.offsetAndRotation(0.0F, -4.5F, 0.0F, 0.0F, 0.7854F, 0.0F));
        ...
        PartDefinition Main = modelPartData.addOrReplaceChild("Main", CubeListBuilder.create().texOffs(6, 20).addBox(-2.0F, -6.9F, -1.5F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 0).addBox(-2.5F, -8.25F, -0.9F, 13.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-1.5F, -6.35F, -1.0F, 11.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-1.5F, -6.15F, -0.9F, 11.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-1.5F, -5.85F, -0.8F, 11.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.0F, 6.9F, -5.7F));

        PartDefinition bone16 = Main.addOrReplaceChild("bone16", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, 0.4397F, -0.842F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, -7.7F, -0.9F, 0.3491F, 0.0F, 0.0F));

        PartDefinition bone17 = Main.addOrReplaceChild("bone17", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, 0.6276F, -0.0896F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, -7.3F, -0.9F, -0.3491F, 0.0F, 0.0F));
        ...
        PartDefinition post = modelPartData.addOrReplaceChild("post", CubeListBuilder.create().texOffs(3, 0).addBox(-1.5F, -23.5F, 0.5F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(3, 0).addBox(-0.5F, -23.5F, 0.5F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(3, 0).addBox(-1.0F, -23.5F, 0.0F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(3, 0).addBox(-1.4F, -23.5F, 0.1F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(3, 0).addBox(-1.2F, -23.9F, 0.3F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(3, 0).addBox(-1.2F, -23.9F, 12.7F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(3, 0).addBox(11.2F, -23.9F, 0.3F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(3, 0).addBox(11.2F, -23.9F, 12.7F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(3, 0).addBox(-1.4F, -22.5F, 0.9F, 1.0F, 23.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(3, 0).addBox(-0.6F, -22.5F, 0.1F, 1.0F, 23.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(3, 0).addBox(-0.6F, -23.5F, 0.9F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(3, 0).addBox(-1.0F, -23.5F, 1.0F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.5F, 23.0F, -7.0F));
        ...
        PartDefinition post2 = modelPartData.addOrReplaceChild("post2", CubeListBuilder.create().texOffs(18, 0).addBox(-1.5F, -23.5F, 0.5F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(18, 0).addBox(-0.5F, -23.5F, 0.5F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(18, 0).addBox(-1.0F, -23.5F, 0.0F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(18, 0).addBox(-1.4F, -22.5F, 0.1F, 1.0F, 23.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(18, 0).addBox(-1.4F, -23.5F, 0.9F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(18, 0).addBox(-0.6F, -23.5F, 0.1F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(18, 0).addBox(-0.6F, -22.5F, 0.9F, 1.0F, 23.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(18, 0).addBox(-1.0F, -23.5F, 1.0F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(6.5F, 23.0F, -7.0F));
        ...
        PartDefinition post3 = modelPartData.addOrReplaceChild("post3", CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -23.5F, 0.5F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-0.5F, -23.5F, 0.5F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-1.0F, -23.5F, 0.0F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-1.4F, -23.5F, 0.1F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-1.4F, -22.5F, 0.9F, 1.0F, 23.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-0.6F, -22.5F, 0.1F, 1.0F, 23.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-0.6F, -23.5F, 0.9F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-1.0F, -23.5F, 1.0F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(6.5F, 23.0F, 5.0F));
        ...
        PartDefinition post4 = modelPartData.addOrReplaceChild("post4", CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -23.5F, 0.5F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-0.5F, -23.5F, 0.5F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-1.0F, -23.5F, 0.0F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-1.4F, -22.5F, 0.1F, 1.0F, 23.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-1.4F, -23.5F, 0.9F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-0.6F, -23.5F, 0.1F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-0.6F, -22.5F, 0.9F, 1.0F, 23.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-1.0F, -23.5F, 1.0F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.5F, 23.0F, 5.0F));
        ...
        PartDefinition Main2 = modelPartData.addOrReplaceChild("Main2", CubeListBuilder.create().texOffs(0, 8).addBox(-5.0F, -2.0F, -6.3F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(10, 14).addBox(1.0F, -16.0F, -6.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 13).addBox(-5.0F, -6.0F, -6.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 0).addBox(-6.5F, -25.35F, -6.6F, 13.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-5.5F, -23.45F, -6.7F, 11.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-5.5F, -23.25F, -6.6F, 11.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition bone22 = Main2.addOrReplaceChild("bone22", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, 0.4397F, -0.842F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -24.8F, -6.6F, 0.3491F, 0.0F, 0.0F));

        PartDefinition bone23 = Main2.addOrReplaceChild("bone23", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, 0.6276F, -0.0896F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -24.4F, -6.6F, -0.3491F, 0.0F, 0.0F));
        ...
        PartDefinition Main3 = modelPartData.addOrReplaceChild("Main3", CubeListBuilder.create().texOffs(0, 16).addBox(-5.0F, -2.0F, -6.3F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(5, 14).addBox(-5.0F, -16.0F, -6.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(2, 13).addBox(4.3F, -6.0F, -6.3F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 10).addBox(-1.0F, -6.0F, -6.3F, 2.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition bone27 = Main3.addOrReplaceChild("bone27", CubeListBuilder.create().texOffs(3, 2).addBox(-0.9621F, -10.9F, -0.7121F, 1.0F, 22.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.25F, -12.1F, -5.3F, 0.0F, -0.7854F, 0.0F));

        PartDefinition bone28 = Main3.addOrReplaceChild("bone28", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, 0.4397F, -0.842F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -24.8F, -6.6F, 0.3491F, 0.0F, 0.0F));

        PartDefinition bone29 = Main3.addOrReplaceChild("bone29", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, 0.6276F, -0.0896F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -24.4F, -6.6F, -0.3491F, 0.0F, 0.0F));
        ...
        PartDefinition Main4 = modelPartData.addOrReplaceChild("Main4", CubeListBuilder.create().texOffs(3, 22).addBox(-5.0F, -2.0F, -6.3F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(7, 13).addBox(1.0F, -16.0F, -6.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(18, 23).addBox(-5.0F, -6.0F, -6.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(8, 15).addBox(-5.0F, -11.0F, -6.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(5, 13).addBox(-5.0F, -16.0F, -6.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(10, 23).addBox(-5.0F, -7.0F, -6.3F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition bone34 = Main4.addOrReplaceChild("bone34", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, 0.4397F, -0.842F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -24.8F, -6.6F, 0.3491F, 0.0F, 0.0F));

        PartDefinition bone35 = Main4.addOrReplaceChild("bone35", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, 0.6276F, -0.0896F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -24.4F, -6.6F, -0.3491F, 0.0F, 0.0F));
        ...
        PartDefinition bone41 = modelPartData.addOrReplaceChild("bone41", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, 26.1F, -13.0F, 15.0F, 1.0F, 15.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(0.5F, 1.2F, -11.5F, 12.0F, 3.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(1.0F, 1.1F, -11.0F, 11.0F, 3.0F, 11.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(1.5F, 1.0F, -10.5F, 10.0F, 3.0F, 10.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(2.0F, 0.9F, -10.0F, 9.0F, 3.0F, 9.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(2.5F, 0.8F, -9.5F, 8.0F, 3.0F, 8.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(3.0F, 0.7F, -9.0F, 7.0F, 3.0F, 7.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(3.5F, 0.6F, -8.5F, 6.0F, 3.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(4.0F, 0.5F, -8.0F, 5.0F, 3.0F, 5.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(4.5F, -0.6F, -7.5F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(28, 26).addBox(6.0F, -2.3F, -6.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.3F))
                .texOffs(20, 29).addBox(6.0F, -1.5F, -6.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.3F)), PartPose.offset(-6.5F, -3.1F, 5.5F));

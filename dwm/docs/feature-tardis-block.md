...
- First-hour advancements (Doctor Who tab): find a TARDIS → claim it, then sibling branches for a same-world hop and binding a key. Gallifrey, cloak, and Stattenheim remote advancements are deferred.

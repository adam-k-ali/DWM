...
public class SixthDoctorTardisModel extends TardisModel {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition Main = modelPartData.addOrReplaceChild("Main", CubeListBuilder.create().texOffs(6, 20).addBox(-2.0F, -6.9F, -1.5F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 0).addBox(-1.5F, -6.35F, -1.1F, 11.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-1.5F, -6.05F, -0.9F, 11.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-1.5F, -5.65F, -0.8F, 11.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.0F, 6.9F, -5.7F));
        ...
        PartDefinition LeftDoor = Main.addOrReplaceChild("LeftDoor", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, 4.0F, 0.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 25).mirror().addBox(-5.0F, 8.0F, -0.3F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
                .texOffs(7, 6).addBox(-5.0F, 4.0F, -0.3F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 8).addBox(-0.7F, -12.0F, -0.3F, 1.0F, 21.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(6, 6).addBox(-5.0F, -2.0F, -0.3F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 9).addBox(-5.0F, -7.0F, -0.3F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition bone18 = LeftDoor.addOrReplaceChild("bone18", CubeListBuilder.create().texOffs(10, 24).addBox(0.8964F, -0.4126F, -0.94F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.2F)), PartPose.offset(-5.7F, -1.6F, 0.3F));
        ...
        PartDefinition Door2 = Main.addOrReplaceChild("Door2", CubeListBuilder.create().texOffs(0, 5).addBox(0.0F, -7.0F, -0.3F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(0.95F, -6.8F, -0.2F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-0.05F, -6.3F, -0.2F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 2).addBox(-0.25F, -2.3F, -0.2F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(3.75F, -5.8F, -0.2F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 15).addBox(0.0F, -2.0F, -0.3F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition bone3 = Door2.addOrReplaceChild("bone3", CubeListBuilder.create().texOffs(3, 2).addBox(-1.1036F, -9.9F, -0.8536F, 1.0F, 21.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.25F, -2.1F, 0.7F, 0.0F, -0.7854F, 0.0F));
        ...
        PartDefinition Window1_2 = Door2.addOrReplaceChild("Window1_2", CubeListBuilder.create().texOffs(2, 23).addBox(-0.3F, -0.1943F, -0.6891F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(2, 23).addBox(-0.3F, 3.3589F, -4.2423F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(2, 23).addBox(-0.3F, 3.2882F, -4.1362F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(22, 20).addBox(-0.4F, 0.6189F, -1.4669F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition window2_2 = Door2.addOrReplaceChild("window2_2", CubeListBuilder.create().texOffs(22, 19).addBox(-4.3891F, -2.4F, 2.9648F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(22, 19).addBox(-4.4421F, 2.6F, 3.0532F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(22, 19).addBox(-6.6342F, 2.6F, 5.2452F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.2F, -8.6357F, 0.7766F, 0.0F, -0.7854F, 0.0F));
        ...
        PartDefinition bone19 = Door2.addOrReplaceChild("bone19", CubeListBuilder.create().texOffs(6, 29).addBox(-1.3309F, -0.8124F, -1.2955F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.025F)), PartPose.offsetAndRotation(5.1714F, -3.6876F, -0.09F, 0.0F, 1.2217F, 0.0F));

        PartDefinition bone40 = Door2.addOrReplaceChild("bone40", CubeListBuilder.create().texOffs(6, 29).addBox(-0.1818F, -1.0124F, -0.8889F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.1214F, -3.6876F, 0.485F, 0.0F, 0.7854F, 0.0F));

        PartDefinition bone16 = Main.addOrReplaceChild("bone16", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, 0.3397F, -0.842F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, -7.7F, -0.9F, 0.3491F, 0.0F, 0.0F));

        PartDefinition bone17 = Main.addOrReplaceChild("bone17", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, 0.7276F, -0.0896F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, -7.3F, -0.9F, -0.3491F, 0.0F, 0.0F));
        ...
        PartDefinition Main2 = modelPartData.addOrReplaceChild("Main2", CubeListBuilder.create().texOffs(0, 8).addBox(-5.0F, -2.0F, -6.3F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 0).addBox(-5.5F, -23.45F, -6.8F, 11.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-5.5F, -23.15F, -6.6F, 11.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-5.5F, -22.75F, -6.5F, 11.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition bone22 = Main2.addOrReplaceChild("bone22", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, 0.3397F, -0.842F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -24.8F, -6.6F, 0.3491F, 0.0F, 0.0F));

        PartDefinition bone23 = Main2.addOrReplaceChild("bone23", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, 0.7276F, -0.0896F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -24.4F, -6.6F, -0.3491F, 0.0F, 0.0F));
        ...
        PartDefinition bone28 = Main3.addOrReplaceChild("bone28", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, 0.3397F, -0.842F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -24.8F, -6.6F, 0.3491F, 0.0F, 0.0F));

        PartDefinition bone29 = Main3.addOrReplaceChild("bone29", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, 0.7276F, -0.0896F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -24.4F, -6.6F, -0.3491F, 0.0F, 0.0F));
        ...
        PartDefinition bone34 = Main4.addOrReplaceChild("bone34", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, 0.3397F, -0.842F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -24.8F, -6.6F, 0.3491F, 0.0F, 0.0F));

        PartDefinition bone35 = Main4.addOrReplaceChild("bone35", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, 0.7276F, -0.0896F, 12.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -24.4F, -6.6F, -0.3491F, 0.0F, 0.0F));
        ...
        PartDefinition bone41 = modelPartData.addOrReplaceChild("bone41", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, 26.1F, -13.0F, 15.0F, 1.0F, 15.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 0).addBox(4.5F, 0.2F, -7.5F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-6.5F, -3.1F, 5.5F));

        PartDefinition bone42 = bone41.addOrReplaceChild("bone42", CubeListBuilder.create().texOffs(24, 28).addBox(-1.0F, -1.2167F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.225F)), PartPose.offsetAndRotation(6.5F, -0.4333F, -5.5F, 0.0F, 0.7854F, 0.0F));

        PartDefinition bone43 = bone42.addOrReplaceChild("bone43", CubeListBuilder.create().texOffs(20, 29).addBox(-0.5F, -0.05F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.2F))
                .texOffs(28, 26).addBox(-0.5F, -1.45F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(0.0F, 0.1083F, 0.0F, 0.0F, 0.7854F, 0.0F));

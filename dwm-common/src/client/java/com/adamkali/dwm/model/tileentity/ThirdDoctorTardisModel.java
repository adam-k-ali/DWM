...
public class ThirdDoctorTardisModel extends TardisModel {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition post = modelPartData.addOrReplaceChild("post", CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -24.0F, 0.5F, 1.0F, 24.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 0).addBox(-1.2F, -25.0F, 0.3F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-1.2F, -25.0F, 12.7F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(11.2F, -25.0F, 0.3F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(11.2F, -25.0F, 12.7F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition LeftDoor = Main.addOrReplaceChild("LeftDoor", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, 4.0F, 0.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 10).addBox(-5.0F, 4.0F, -0.3F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 6).addBox(-0.7F, -12.0F, -0.3F, 1.0F, 21.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 15).addBox(-5.0F, -2.0F, -0.3F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 4).addBox(-5.0F, -12.0F, -0.3F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition bone18 = LeftDoor.addOrReplaceChild("bone18", CubeListBuilder.create().texOffs(10, 24).addBox(0.7964F, -0.3876F, -0.94F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.2F)), PartPose.offset(-5.7F, -1.6F, 0.3F));
        ...
        PartDefinition Door2 = Main.addOrReplaceChild("Door2", CubeListBuilder.create().texOffs(0, 5).addBox(0.0F, -7.0F, -0.3F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 4).addBox(0.0F, -12.0F, -0.3F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(22, 15).addBox(0.0F, -11.1F, -0.08F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(0.0F, -1.0F, 0.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 0).addBox(4.0F, 4.0F, -0.3F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 17).addBox(0.0F, 3.0F, -0.3F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 25).addBox(0.0F, 8.0F, -0.3F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(0.0F, 4.0F, 0.0F, 4.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(0, 5).addBox(-0.3F, -12.0F, -0.3F, 1.0F, 21.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 7.1F, -0.3F));
        ...
        PartDefinition window2_2 = Door2.addOrReplaceChild("window2_2", CubeListBuilder.create().texOffs(22, 19).addBox(-4.3891F, -2.4F, 2.9648F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(22, 19).addBox(-4.4775F, 5.4F, 2.8764F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(22, 19).addBox(-4.4775F, 2.9F, 2.8764F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(22, 19).addBox(-6.7225F, -2.4F, 5.2983F, 1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.2F, -8.6357F, 0.7766F, 0.0F, -0.7854F, 0.0F));
        ...
        PartDefinition Main2 = modelPartData.addOrReplaceChild("Main2", CubeListBuilder.create().texOffs(1, 22).addBox(-5.0F, -2.0F, -6.3F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 0).addBox(-5.0F, -7.0F, -6.3F, 10.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition bone21 = Main2.addOrReplaceChild("bone21", CubeListBuilder.create().texOffs(0, 0).addBox(-0.9621F, -10.9F, -0.7121F, 1.0F, 22.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.25F, -12.1F, -5.3F, 0.0F, -0.7854F, 0.0F));
        ...
        PartDefinition bone40 = modelPartData.addOrReplaceChild("bone40", CubeListBuilder.create().texOffs(20, 29).addBox(-0.5F, -0.25F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(28, 26).addBox(-0.5F, -1.25F, -0.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.05F, 0.0F, 0.0F, 0.7854F, 0.0F));

        PartDefinition bb_main = modelPartData.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(0, 0).addBox(-7.0F, -1.0F, -7.0F, 14.0F, 1.0F, 14.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-6.0F, -26.4F, -6.0F, 12.0F, 3.0F, 12.0F, new CubeDeformation(0.0F))
                .texOffs(24, 23).addBox(-1.0F, -27.1F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(24, 28).addBox(-1.0F, -29.1F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-5.5F, -26.45F, -5.5F, 11.0F, 3.0F, 11.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-5.0F, -26.5F, -5.0F, 10.0F, 3.0F, 10.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-4.5F, -26.55F, -4.5F, 9.0F, 3.0F, 9.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-4.0F, -26.6F, -4.0F, 8.0F, 3.0F, 8.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-3.5F, -26.65F, -3.5F, 7.0F, 3.0F, 7.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-3.0F, -26.7F, -3.0F, 6.0F, 3.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-2.5F, -26.75F, -2.5F, 5.0F, 3.0F, 5.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-2.0F, -26.8F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-1.5F, -26.85F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));

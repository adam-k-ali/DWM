...
class ScreenplayExtension {
    ...
    /**
     * Additional YAML roots to scan for {@code runScreenplayTests} discovery.
     */
     ...
     */
    String runDir = 'build/screenplay/run'

    /**
     * Build-relative output directory for reports, metrics, and archives.
     */
    String outputDir = 'screenplay'

    ScreenplayExtension(Project project) {
        this.testsDir = project.file('src/screenplayTests/resources/tests')
    }
